...
if "wife" in a: print("wife") #거짓
elif "python" in a and "you" not in a: print("python") #거짓
...
#[70,60,55,75,95,90,80,80,85,100] for문을 사용하여 A학급의 평균 점수를 구해보자.

#6. 리스트 중에서 홀수에만 2를 곱하여 저장하는 다음 코드가 있다. 코드를 리스트 내포(list comprehension)를 사용하여 표현해 보자.
numbers = [1, 2, 3, 4, 5]
result = []
for n in numbers:
    if n % 2 == 1:
